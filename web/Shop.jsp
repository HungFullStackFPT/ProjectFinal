                ...
                <div class="container" style="margin-top: -66px">
                                ...
                                <div class="col-12 col-md-5">
                                    <div class="d-flex flex-wrap">
                                        <div class="select-outline position-relative w-100">
                                            ...
                                            <label><a class="btn btn-outline-primary" href="http://localhost:8080/ProjectFinal/shop">Tất cả sản phẩm</a></label>
                    ...
                    <script>
                                                ...
                                                function searchByName(param) {
                                                    ...
                                                    $.ajax({
                                                        url: "/ProjectFinal/searchAjaxShop",
                                                        type: "get", //send it through get method
                                                        data: {
                                                            txt: txtSearch
                                                        },
                                                ...
                                                function searchByPriceMinToMax() {
                                                    ...
                                                    $.ajax({
                                                        url: "/ProjectFinal/searchAjaxPriceMinToMax",
                                                        type: "get", //send it through get method
                                                        data: {
                                                            priceMin: numMin,
                                                            priceMax: numMax
                                                ...
                                                function searchByPriceUnder100() {
                                                    $.ajax({
                                                        url: "/ProjectFinal/searchAjaxPriceUnder100Shop",
                                                        type: "get", //send it through get method
                                                        data: {
                                                ...
                                                function searchByPrice100To200() {
                                                    $.ajax({
                                                        url: "/ProjectFinal/searchAjaxPrice100To200Shop",
                                                        type: "get", //send it through get method
                                                        data: {
                                                ...
                                                function searchByPriceAbove200() {
                                                    $.ajax({
                                                        url: "/ProjectFinal/searchAjaxPriceAbove200Shop",
                                                        type: "get", //send it through get method
                                                        data: {
